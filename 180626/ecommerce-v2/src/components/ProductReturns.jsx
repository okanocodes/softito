        ...
        <>
            <main className="tracking-container">
                <div className="tracking-card">
                    ...
                    <form >
                        <div className="form-group">
                            ...
                            <input type="text" className="form-input" placeholder="Örn: 12345" />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            ...
                            <textarea placeholder="İade etmek istediğiniz ürünleri ve detayları belirtiniz..."
                ...
                <div className="tracking-card">
                    ...
                    <p className="value-desc">2. Size verilecek kargo kodula ürünü paketleyin</p>
