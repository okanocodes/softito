            ...
            <main className="help-container">
                <div className="faq-section">
                    ...
                    {FAQ_DATA.map((faq, index) => (
                        <div className="faq-card" key={index} onClick={() => handleToggle(index)}>
                ...
                <div className="support-section">
                    ...
                    <form onSubmit={(e) => e.preventDefault()}>
                        <div className="form-group">
                            ...
                            <input className="form-input" placeholder="Örn: Ahmet Yılmaz" type="text" />
                        </div>
                        <div className="form-group">
                            <label className="form-label">E-Posta Adresiniz</label>
                            <input className="form-input" placeholder="ahmet@yilmaz.com" type="email" />
                        </div>
                        <div className="form-group">
                            <label className="form-label">Mesajınız</label>
                            <textarea className="form-textarea" placeholder="Talebinizi buraya deraylıca yazınız.." />
                        </div>
