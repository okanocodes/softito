                ...
                {trackedOrder && (
                    ...
                    <div className="tracking-card">
                        ...
                        <div className="timeline">
                            ...
                            <div className="timeline-step">
                                <div className="timeline-icon timeline-icon">3</div>
                                <span className="timeline-label timeline-label">Kargoya Verildi</span>
                            </div>
                            <div className="timeline-step">
                                <div className="timeline-icon timeline-icon">4</div>
                                <span className="timeline-label timeline-label">Teslim Edildi</span>
                            </div>
                        </div>
                    </div>
                )}
